  ...
  return (
    <div className="space-y-6 p-6">
      <div>
        ...
        <p className="text-muted-foreground">Commission accrual and budget analysis</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <Card className="p-5">
          <div className="flex items-center justify-between mb-2">
            <p className="text-sm font-medium text-muted-foreground">Commission Accrual</p>
        ...
        <Card className="p-5">
          <div className="flex items-center justify-between mb-2">
            <p className="text-sm font-medium text-muted-foreground">Budget MTD</p>
            <Target className="h-4 w-4 text-muted-foreground" />
          </div>
          <p className="text-2xl font-bold">₹10.80 Cr</p>
          <p className="text-sm text-muted-foreground mt-1">Allocated this month</p>
        </Card>
        <Card className="p-5">
          <div className="flex items-center justify-between mb-2">
      ...
      <Card className="p-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">₹8.47 Cr of ₹10.80 Cr utilized</p>
          </div>
      ...
      <Card className="p-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Next 3 months projected commission</p>
          </div>
