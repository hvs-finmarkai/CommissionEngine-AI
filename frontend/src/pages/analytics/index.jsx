  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 dark:text-gray-400 dark:text-gray-500">Commission effectiveness and ROI analysis</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-500 dark:text-gray-400 dark:text-gray-500">Commission ROI</p>
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-500 dark:text-gray-400 dark:text-gray-500">Revenue per ₹1 Commission</p>
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-500 dark:text-gray-400 dark:text-gray-500">Avg Payout Time</p>
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-500 dark:text-gray-400 dark:text-gray-500">Dispute Resolution</p>
        ...
        <ul className="space-y-3">
          {insights.map((insight, index) => (
            <li key={index} className="flex items-start gap-3">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500">{insight}</p>
            </li>
          ))}
        </ul>
      </Card>
